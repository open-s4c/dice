...
PS_ADVERTISE_TYPE(EVENT_MA_READ)
PS_ADVERTISE_TYPE(EVENT_MA_WRITE)
PS_ADVERTISE_TYPE(EVENT_MA_AREAD)
PS_ADVERTISE_TYPE(EVENT_MA_AWRITE)
PS_ADVERTISE_TYPE(EVENT_MA_RMW)
PS_ADVERTISE_TYPE(EVENT_MA_XCHG)
PS_ADVERTISE_TYPE(EVENT_MA_CMPXCHG)
PS_ADVERTISE_TYPE(EVENT_MA_CMPXCHG_WEAK)
PS_ADVERTISE_TYPE(EVENT_MA_FENCE)
